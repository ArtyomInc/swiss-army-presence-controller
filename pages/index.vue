...
useSeoMeta({
  description:
    'Application gratuite et open source pour gérer facilement les présences de vos sections militaires. Interface moderne, stockage local sécurisé.',
  title: 'Swiss Army Presence Controller'
})
</script>
